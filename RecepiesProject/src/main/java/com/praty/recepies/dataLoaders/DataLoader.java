package com.praty.recepies.dataLoaders;
...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        Optional<UnitOfMeasure> tableSpoonUomOptional = unitOfMeasureRepository
        		.findByUnitOfMeasure("Tablespoon");
        ...
        log.debug("===No exception Encountered===");
        ...
        guacRecipe.addIngredient(new Ingredient("minced red onion or thinly sliced green onion",
        		new BigDecimal(2), tableSpoonUom));
        guacRecipe.addIngredient(new Ingredient("serrano chiles, stems and seeds removed, "
        		+ "minced", new BigDecimal(2), eachUom));
        ...
        guacRecipe.getSetOfCategories().add(americanCategory);
        guacRecipe.getSetOfCategories().add(mexicanCategory);
        ...
        tacosRecipe.getSetOfCategories().add(americanCategory);
        tacosRecipe.getSetOfCategories().add(mexicanCategory);
        ...
        log.debug("===Completed DataLOading===");
        return recipes;
    }
}